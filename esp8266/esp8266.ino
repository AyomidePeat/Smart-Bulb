...
int ledpin = 2; //defining the OUTPUT pin for LED (D2)

const char *ssid =  "ComputerSurgeon";   //Wifi SSID (Name)   
const char *pass =  "shally"; //wifi password
...
//webscket event method
    ...
    switch(type) {
        ...
        case WStype_CONNECTED:{
            //case when websocket is connected
